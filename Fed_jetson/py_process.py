...
def inference_thread():
    ...
    if(setup_done==False):
        ...
        # MJ we are creating 2 distinct subsets. Ignore 'labled' and unlabled' term

        # MJ : Use following for onion dataset. SWAP the order in the other client code. We will use 'labled_subset' subset as our local dataset for federated learning
        ...
        # MJ:use following for apple
        # unlabled_subset=[img for i, img in enumerate(image_datasets['train'])if i%29=0 ]
        # labled_subset=  [img for i, img in enumerate(image_datasets['train'])if i%30==0 ]
...
def send_file_scp():    #this function invokes file transfer in scptrial.py file
    fp="talk.txt"
